...
1. Загрузка CSV / Excel (Тинькофф, Сбер, Альфа).
2. Статьи расходов как в банке.
3. Очередь «куда ушли деньги» для переводов без статьи.
4. Цель месяца (сальдо) на сайте или `/цель 80000`.
5. В группу: итоги, всплески, как дотянуть цель, кнопки норма / сократить / не расход.

Переводы «между своими» в доходы/расходы не входят.
