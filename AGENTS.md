...
12. При проверке претензий клиентов салона и подготовке ответов используй `.cursor/skills/consumer-claims-salon/SKILL.md`.
13. После важных изменений — обнови память и скопируй на VPS:
