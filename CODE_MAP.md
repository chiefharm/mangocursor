...
| `personal-finance/` | **Отдельный** личный учёт: выписка (PDF/CSV/Excel или папка Google Drive) → сайт → пояснение переводов. Группа Telegram: итоги, цель, всплески, кнопки. Не салон/Mango |
