...
Локальный навык: `.cursor/skills/consumer-claims-salon/SKILL.md`.

Использовать для проверки досудебных претензий по окрашиванию, стрижкам и другим услугам, а также для подготовки ответов. Основные принципы:

- не признавать недостаток до осмотра и проверки доказательств;
- письменно предлагать бесплатный осмотр и устранение подтверждённого недостатка;
- фиксировать отказ или неявку клиента;
- отвечать на денежные требования в пределах установленного законом срока;
- не угрожать судом, а нейтрально разъяснять распределение судебных расходов;
- возврат по карте проводить обратной операцией по исходному платежу.
