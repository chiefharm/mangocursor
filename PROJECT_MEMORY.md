...
**Задача владельца (Егор, Telegram `@petrovego`, ID `789815398`):**
...
|------|-------------|--------|
| **moscow** | `789815398` | **«звонки Москва Фили»** `-5388696382` |
| **krasnoyarsk** | `789815398` | **«Звонки soco красноярsk»** `-5228349427` |
...
| Параметр | Значение |
|----------|----------|
| IP | `72.56.27.174` (`deploy/vps.host`) |
| Путь | `/opt/mango-pipeline` |
| SSH | `ssh -i ~/.ssh/id_ed25519 root@72.56.27.174` |
